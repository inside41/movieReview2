...
<form action="memberForm.do">
 <table width="800" height="650">
  <tr>
   <td width="100%" height="10%">
   <span style="padding-left:260px">
 <!--  <img src="/image/Booktopia_Logo.jpg" width="100" height="100" border="0"align="middle"> -->
   </span>&nbsp; &nbsp;<b>회원가입 약관</b>
    <br>
    <hr>
   </td>
...
- 생성정보 수집 툴을 통한 수집
   ...
   <br>
   <input type="checkbox" id="동의" name="req" required/> 개인정보 수집 및 이용에 동의합니다.
   </td>
  </tr>
  <tr>
...
<input type="submit" value="확인"  /></button>&nbsp;&nbsp;&nbsp;
 <input type="button" onclick="location.href='../main/main.do'" value="취소"/>
