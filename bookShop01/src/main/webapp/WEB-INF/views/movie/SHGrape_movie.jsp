         ...
         <div class="bodycolumn">
            ...
            <div class="card">
               ...
               <div class="info" style="height: 3000px">
                  <strong class="title1">007 노 타임 투 다이</strong>&nbsp&nbsp
                  <img src="/img/sangyoung.jpg" alt="상영중">
                  <br>
                  <span class="minititle1">007 NO Time To Die, 2021</span>
                  <br><br>
                  <!-- 007 트레일러,이미지 div -->
                  <div class="doubleo">
                     <iframe width="560" height="315" src="https://www.youtube.com/embed/N_gD9-Oa0fg"
                        title="YouTube video player" frameborder="0"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                        allowfullscreen></iframe>
                     <img class="doubleoimg" src="/img/007.jpg" alt="007">
                  </div>
                  <!-- 신선도 -->
                  <div class="sinsun">
                     <span class="sinsun1"><strong>007 노 타임 투 다이</strong></span>
                     <br><br><br>
                     <span class="sinsun2">액션 | 미국,영국 | 163분 | 2021.09.29 개봉 </span>
                     <img class="grape" src="img/grape.jpg" alt="포도">
                     <br><br><br> <br><span class="sinsun3">84%</span>
                     <img class="popcon" src="img/popcon.jpg" alt="팝콘">
                  ...
                  <div class="actor">
                     ...
                     <div>
                        <div class="imgbond">
                           <img src="img/다니엘 크레이그.jpg" alt="제임스 본드">
                           <span class="다니엘"> <strong>다니엘 크레이그</strong><br> <span class="bondtext1">Danel Craig</span>
                              <br> <span class="bondtext2"><span style="color: red;">주연</span> | 제임스 본드 역 <br> 007 노 타임
                                 투 다이, 2021 <br> 나이브스 아웃, 2019</span> </span>
                        </div>
                        <div class="imgsafin">
                           <img src="img/라미 말렉.jpg" alt="사핀">
                        ...
                        <div class="imglea">
                           <img src="img/레아 세이두.jpg" alt="매들린 스완">
                        ...
                        <div class="ralph">
                           <img src="img/랄프 파인즈.jpg" alt="더 디그">
                        ...
                        <div class="naomie">
                           <img src="img/나오미 해리스.jpg" alt="이브 머니페이">
                        ...
                        <div class="ana">
                           <img src="img/아나 디 아르마스.jpg" alt="팔로마">
                  ...
                  <div class="producer">
                     ...
                     <br>
                     <span style="color: red;">수입 </span> | 유니버설 픽쳐스
                     <br><span style="color: red;">배급 </span> | 유니버설 픽쳐스
                  </div>
                  ...
                  <div class="director">
                     ...
                     <div class="neal">
                        <p>닐 퍼비스 <span style="color: gray;">Neal Purvis </span></p>
                     ...
                     <div class="neal">
                        <p>바바라 브로콜리 <span style="color: gray;">Barbara Broccoli </span></p>
